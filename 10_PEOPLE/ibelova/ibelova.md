...
|------|----------------|------|--------|
| 02.06.2026 | Уточнить у Кости Галактионова процесс выгрузки SD Pro в Грамокс | — | ⬜ |
| 02.06.2026 | Выгрузить публичную доку SMP 4.21.0 в Грамокс (заручиться доступом через Ваню) | — | ⬜ |
